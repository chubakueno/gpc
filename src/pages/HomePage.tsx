...
export default function HomePage() {
  ...
  return (
    <main className="max-w-5xl mx-auto px-4 sm:px-6 py-16">
      ...
      <section className="mb-12">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          >
            ...
            <h2 className="text-lg font-semibold text-[var(--color-text)] mb-2 group-hover:text-[var(--color-accent-2)] transition-colors">
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-[var(--color-accent)]/20 flex items-center justify-center mb-4">
              <span className="text-[var(--color-accent)] text-xl font-mono">AC</span>
            </div>
            <h2 className="text-lg font-semibold text-[var(--color-text)] mb-2 group-hover:text-[var(--color-accent)] transition-colors">
              {t("home.card.ac.title")}
            </h2>
            <p className="text-sm text-[var(--color-muted)] leading-relaxed mb-4">
              {t("home.card.ac.desc")}
            </p>
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-[var(--color-accent-2)]/20 flex items-center justify-center mb-4">
              <span className="text-[var(--color-accent-2)] text-xl font-mono">ST</span>
            </div>
            <h2 className="text-lg font-semibold text-[var(--color-text)] mb-2 group-hover:text-[var(--color-accent-2)] transition-colors">
              {t("home.card.st.title")}
            </h2>
            <p className="text-sm text-[var(--color-muted)] leading-relaxed mb-4">
              {t("home.card.st.desc")}
            </p>
            <div className="flex flex-wrap gap-2">
              {["O(N) Ukkonen", "O(M) Search", "Compressed Trie"].map((tag) => (
                <span key={tag} className="text-xs px-2 py-0.5 rounded-full bg-[var(--color-surface-2)] text-[var(--color-muted)] border border-[var(--color-border)]">
                  {tag}
                </span>
              ))}
      ...
      {/* Miscellaneous */}
      <section className="mb-12">
        <CategoryHeading label={t("home.category.misc")} />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link
            to="/nim"
            className="group block rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 no-underline hover:border-[var(--color-accent-3)] transition-all duration-200 hover:shadow-lg hover:shadow-[var(--color-accent-3)]/10"
          >
            <div className="w-10 h-10 rounded-xl bg-[var(--color-accent-3)]/20 flex items-center justify-center mb-4">
              <span className="text-[var(--color-accent-3)] text-xl font-mono">⊕</span>
            </div>
            <h2 className="text-lg font-semibold text-[var(--color-text)] mb-2 group-hover:text-[var(--color-accent-3)] transition-colors">
              {t("home.card.nim.title")}
            </h2>
            <p className="text-sm text-[var(--color-muted)] leading-relaxed mb-4">
              {t("home.card.nim.desc")}
            </p>
            <div className="flex flex-wrap gap-2">
              {["Sprague-Grundy", "XOR theorem", "P/N-positions"].map((tag) => (
                <span
                  key={tag}
                  className="text-xs px-2 py-0.5 rounded-full bg-[var(--color-surface-2)] text-[var(--color-muted)] border border-[var(--color-border)]"
                >
      ...
      {/* Graphs & Trees */}
      <section>
        <CategoryHeading label={t("home.category.graphs")} />
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          <Link
            to="/ufds"
            className="group block rounded-2xl border border-[var(--color-border)] bg-[var(--color-surface)] p-6 no-underline hover:border-[var(--color-accent-2)] transition-all duration-200 hover:shadow-lg hover:shadow-[var(--color-accent-2)]/10"
          ...
          >
            <div className="w-10 h-10 rounded-xl bg-[var(--color-warn)]/20 flex items-center justify-center mb-4">
              <span className="text-[var(--color-warn)] text-xl font-mono">→</span>
            </div>
            <h2 className="text-xl font-semibold text-[var(--color-text)] mb-2 group-hover:text-[var(--color-warn)] transition-colors">
              {t("home.card.dijkstra.title")}
            </h2>
            <p className="text-sm text-[var(--color-muted)] leading-relaxed mb-4">
              {t("home.card.dijkstra.desc")}
            </p>
            <div className="flex flex-wrap gap-2">
              {["Priority Queue", "O((V+E) log V)", "Greedy"].map((tag) => (
                <span
                  key={tag}
                  className="text-xs px-2 py-0.5 rounded-full bg-[var(--color-surface-2)] text-[var(--color-muted)] border border-[var(--color-border)]"
                >
          ...
          >
            ...
            <h2 className="text-xl font-semibold text-[var(--color-text)] mb-2 group-hover:text-[var(--color-accent-2)] transition-colors">
              {t("home.card.lca.title")}
            </h2>
            <p className="text-sm text-[var(--color-muted)] leading-relaxed mb-4">
              {t("home.card.lca.desc")}
            </p>
            <div className="flex flex-wrap gap-2">
              {["Binary Lifting", "O(log n)", "Euler Tour + RMQ"].map((tag) => (
                <span
                  key={tag}
                  className="text-xs px-2 py-0.5 rounded-full bg-[var(--color-surface-2)] text-[var(--color-muted)] border border-[var(--color-border)]"
                >
